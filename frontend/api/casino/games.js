module.exports = async (req, res) => {
  res.status(200).json({
    ...
    dice: { name: 'dice', displayName: 'Agent Dice', rtp: '95.0%', houseEdge: '5.0%', targetRange: '1-99', dynamicMultiplier: true, minBet: '0.0001 Ξ', description: 'Roll over or under. You choose the risk and reward.' },
